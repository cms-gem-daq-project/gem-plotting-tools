...
html_context = {
    ...
    "github_repo": "gem-plotting-tools",
    "github_version": "release/legacy-1.5",
...
html_title = "gemplotting: Python Tools for Plotting GEM DAQ Information"

# A shorter title for the navigation bar.  Default is the same as html_title.
html_short_title = "gemplotting"
...
latex_documents = [
    ("index", "gemplotting.tex", u"gemplotting Documentation", authors, "manual",),
]
